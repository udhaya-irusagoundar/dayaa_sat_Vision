            ...
            <div class="card-content">
                <form method="POST" action="{{ route('login_submit') }}" id="loginForm" class="login-form">
                    ...
                    <div class="form-group">
                        ...
                        <input id="username" name="username" type="text" class="form-input @error('username') is-invalid @enderror" placeholder="Enter your username" value="{{ old('username') }}" required>
                        @error('username')
                    ...
                    <div class="form-group password-wrapper">
                        ...
                        <input id="password" type="password" name="password" class="form-input @error('password') is-invalid @enderror" placeholder="Enter your password" required>
